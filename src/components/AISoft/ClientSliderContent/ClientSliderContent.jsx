      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
        <div>
          ...
          <p style={{ fontSize: '15px', marginTop: '10px', maxWidth: '600px' }}>
            Our commitment to excellence has earned us numerous industry awards and recognitions. These accolades reflect our dedication to delivering innovative, high-quality software solutions that drive real growth and success.
          </p>
        </div>
        <div>
